...
import com.manager.general.specification.PersonWithFirstName;
...
public class PersonController {
    ...
    @GetMapping("/with-firstname")
    public ResponseEntity<List<Person>> findAllPersonsWithFirstName(
            @RequestParam(required = false) String firstName) {

        Specification<Person> spec = new PersonWithFirstName(firstName);
        List<Person> persons = personService.findAllPersons(spec);
